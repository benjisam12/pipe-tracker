...
export default function Home() {
    ...
    // Group projects by priority for dashboard
        ...
        return (
            ...
            >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    <div>
                        <div style={{ fontWeight: '600', fontSize: compact ? '14px' : '16px', color: '#1f2937' }}>
                            {project.customer}
                        </div>
                        {!compact && project.project_name && (
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ fontSize: compact ? '16px' : '18px', fontWeight: '700', color: '#059669' }}>
                        {formatAmount(project.quote_amount)}
                    </div>
                    <div style={{ fontSize: '12px', color: '#9ca3af' }}>
                        {getTimeAgo(project.last_follow_up)}
                    </div>
                </div>
    ...
    const TaskListCard = ({ list }) => {
        ...
        return (
            <div style={{
                ...
                <button
                    onClick={() => {
                        setEditingTask({ list_id: list.id });
                ...
                <div>
                    <div style={{
                        ...
                        <span style={{
                            ...
                            {superPriorityProjects.length}
                        </span>
                    </div>
                    {superPriorityProjects.map(project => (
                        <ProjectCard key={project.id} project={project} compact />
                    ))}
                    {superPriorityProjects.length === 0 && (
                        <div style={{ textAlign: 'center', padding: '20px', color: '#9ca3af', fontSize: '14px' }}>
                            No super priority projects
                        </div>
                    )}
                </div>
                ...
                <div>
                    <div style={{
                        ...
                        <span style={{
                            ...
                            {nonPriorityProjects.length}
                        </span>
                    </div>
                    {nonPriorityProjects.map(project => (
                        <ProjectCard key={project.id} project={project} compact />
                    ))}
                    {nonPriorityProjects.length === 0 && (
                        <div style={{ textAlign: 'center', padding: '20px', color: '#9ca3af', fontSize: '14px' }}>
                            No non-priority projects
                        </div>
                    )}
                </div>
                ...
                <div>
                    ...
                    {taskLists.length === 0 && (
                        <div style={{
                            ...
                            No task lists yet.<br/>Create one to get started!
                        </div>
                    )}
    ...
    // Projects Tab with different views
    const ProjectsTab = () => (
        <div>
            {/* Toolbar */}
            <div style={{
                    ...
                    {['cards', 'kanban', 'list', 'table'].map(view => (
                        <button
                            ...
                            style={{
                                ...
                                color: viewMode === view ? '#3b82f6' : '#6b7280',
                                fontWeight: viewMode === view ? '600' : '400',
                                boxShadow: viewMode === view ? '0 1px 2px rgba(0,0,0,0.1)' : 'none'
                            }}
                        >
                            {view === 'cards' ? '📇' : view === 'kanban' ? '📊' : view === 'list' ? '📝' : '📋'} {view.charAt(0).toUpperCase() + view.slice(1)}
                        </button>
                    ))}
                </div>
                    ...
                    {filteredProjects.map((project, i) => (
                        <div
                            ...
                            style={{
                                ...
                                alignItems: 'center',
                                padding: '16px 20px',
                                borderBottom: i < filteredProjects.length - 1 ? '1px solid #f3f4f6' : 'none',
                                cursor: 'pointer',
                        ...
                        >
                            ...
                            <div style={{ width: '120px', textAlign: 'right' }}>
                                <div style={{ fontWeight: '700', color: '#059669' }}>{formatAmount(project.quote_amount)}</div>
                            </div>
            ...
            {filteredProjects.length === 0 && (
                <div style={{ textAlign: 'center', padding: '60px 20px', color: '#6b7280' }}>
                    ...
                    <div style={{ fontSize: '18px', fontWeight: '500' }}>No projects found</div>
                ...
                <div>
                    ...
                    <div style={{ background: 'white', borderRadius: '12px', padding: '20px' }}>
                        ...
                        {completedTasks.length > 0 && (
                            <>
                                <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#6b7280', marginTop: '24px', marginBottom: '16px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'grid', gap: '16px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Customer *</label>
                                <input
                                    type="text"
                                    value={form.customer}
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Project Name / Details</label>
                            <input
                                type="text"
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Quote Amount ($)</label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Margin (%)</label>
                                <input
                                    type="number"
                                    value={form.margin}
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Next Steps</label>
                            <textarea
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>
                                💡 AI Reminder Question
                            </label>
                            <input
                                type="text"
                                value={form.reminder_question}
                                onChange={(e) => setForm({...form, reminder_question: e.target.value})}
                                style={{ width: '100%', padding: '10px', border: '1px solid #e5e7eb', borderRadius: '8px' }}
                                placeholder="e.g., Did we receive the LC Draft?"
                            />
                        </div>
                    ...
                    <div style={{ display: 'flex', gap: '12px', marginTop: '24px' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: 'none',
                                borderRadius: '8px',
                                background: form.customer ? '#3b82f6' : '#e5e7eb',
                                color: form.customer ? 'white' : '#9ca3af',
                                cursor: form.customer ? 'pointer' : 'not-allowed',
                                fontSize: '14px',
                                fontWeight: '600'
                            }}
                        >
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'grid', gap: '16px' }}>
                        <div>
                            <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', marginBottom: '6px' }}>Task Title *</label>
                            <input
                                type="text"
                                value={form.title}
                        ...
                        <div>
                            ...
                            <select
                                value={form.list_id || ''}
                                onChange={(e) => setForm({...form, list_id: e.target.value ? parseInt(e.target.value) : null})}
                                style={{ width: '100%', padding: '10px', border: '1px solid #e5e7eb', borderRadius: '8px' }}
                            >
                    ...
                    <div style={{ display: 'flex', gap: '12px', marginTop: '24px' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: 'none',
                                borderRadius: '8px',
                                background: form.title ? '#3b82f6' : '#e5e7eb',
                                color: form.title ? 'white' : '#9ca3af',
                                cursor: form.title ? 'pointer' : 'not-allowed',
                                fontWeight: '600'
                            }}
                        >
                            {editingTask?.id ? 'Save Changes' : 'Add Task'}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            {selectedProject.project_name && (
                                <div style={{ color: '#6b7280' }}>{selectedProject.project_name}</div>
                            )}
                        </div>
                        <button
                            onClick={() => setSelectedProject(null)}
                            style={{ background: 'none', border: 'none', fontSize: '28px', cursor: 'pointer', color: '#6b7280' }}
                        >
                            ×
                        </button>
                    </div>
                    ...
                    <div style={{ padding: '24px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '24px' }}>
                            <div style={{ background: '#f0fdf4', padding: '16px', borderRadius: '12px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Quote Amount</div>
                                <div style={{ fontSize: '24px', fontWeight: '700', color: '#059669' }}>
                                    {formatAmount(selectedProject.quote_amount)}
                                </div>
                            </div>
                            <div style={{ background: '#eff6ff', padding: '16px', borderRadius: '12px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Margin</div>
                                <div style={{ fontSize: '24px', fontWeight: '700', color: '#3b82f6' }}>
                                    {selectedProject.margin || 0}%
                                </div>
                            </div>
                            <div style={{ background: '#faf5ff', padding: '16px', borderRadius: '12px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Status</div>
                                <div style={{ fontSize: '24px', fontWeight: '700', color: '#8b5cf6', textTransform: 'capitalize' }}>
                        ...
                        {selectedProject.manufacturer && (
                            <div style={{ marginBottom: '20px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Manufacturer</div>
                                <div style={{ fontSize: '16px', fontWeight: '500' }}>{selectedProject.manufacturer}</div>
                            </div>
                        )}

                        {selectedProject.reminder_question && (
                            <div style={{
                                background: '#fef3c7',
                                padding: '16px',
                                borderRadius: '12px',
                                ...
                                <div style={{ fontSize: '13px', color: '#92400e', marginBottom: '4px' }}>💡 AI Reminder</div>
                        ...
                        {selectedProject.next_steps && (
                            <div style={{ marginBottom: '20px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Next Steps</div>
                                <div style={{ fontSize: '15px', lineHeight: '1.6' }}>{selectedProject.next_steps}</div>
                            </div>
                        )}

                        {selectedProject.notes && (
                            <div style={{ marginBottom: '20px' }}>
                                <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '4px' }}>Notes</div>
                                <div style={{ fontSize: '15px', lineHeight: '1.6', color: '#4b5563' }}>{selectedProject.notes}</div>
                            </div>
                        )}

                        <div style={{ fontSize: '13px', color: '#9ca3af', marginTop: '20px' }}>
                            Last follow-up: {getTimeAgo(selectedProject.last_follow_up)}
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        <button
                            onClick={() => markFollowUp(selectedProject.id)}
                            style={{
                                padding: '12px 20px',
                                background: '#22c55e',
                                color: 'white',
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '48px', marginBottom: '16px' }}>🏭</div>
                    <div style={{ fontSize: '18px', color: '#6b7280' }}>Loading Pipe Tracker...</div>
                </div>
            </div>
        );
    }
